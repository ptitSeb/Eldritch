...
/*virtual*/ void SDPEldHUDCalibration::SetShaderParameters(
    IRenderer* const pRenderer, Mesh* const pMesh, const View& View) const {
  ...
  pRenderer->SetPixelShaderFloat4(sConstantColor,
                                  pMesh->m_ConstantColor.GetArray(), 1);
}