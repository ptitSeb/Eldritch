...
AnimEventEldExecuteAction::AnimEventEldExecuteAction() : m_Actions() {}
...
void AnimEventEldExecuteAction::InitializeFromDefinition(
...
void AnimEventEldExecuteAction::Call(Mesh* pMesh, Animation* pAnimation) {
  ...
  WBEntity* const pEntity =
      WBCompOwner::GetTopmostOwner(pEldritchMesh->GetEntity());
  DEVASSERT(pEntity);
