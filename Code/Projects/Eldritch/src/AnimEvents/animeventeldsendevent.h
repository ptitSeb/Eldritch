...
// Because there's no action stack for anim events, we can't query it the way we
// would for most events.
// TODO: Completely overhaul anim event system to use WB events. But that's
// beyond the scope I'm dealing with for now.
