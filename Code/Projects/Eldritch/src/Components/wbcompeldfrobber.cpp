...
WBCompEldFrobber::WBCompEldFrobber()
    : m_FrobDistance(0.0f), m_FrobTarget(), m_FrobDisabled(false) {}

WBCompEldFrobber::~WBCompEldFrobber() {}

/*virtual*/ void WBCompEldFrobber::InitializeFromDefinition(
  ...
  m_FrobDistance =
      ConfigManager::GetInheritedFloat(sFrobDistance, 0.0f, sDefinitionName);
}
