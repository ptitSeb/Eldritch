...
WBCompEldLock::WBCompEldLock() : m_Locked(false), m_Key() {}

WBCompEldLock::~WBCompEldLock() {}

/*virtual*/ void WBCompEldLock::InitializeFromDefinition(
  ...
  STATICHASH(Key);
  m_Key = ConfigManager::GetInheritedHash(sKey, HashedString::NullString,
                                          sDefinitionName);
}
