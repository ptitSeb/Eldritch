...
WBCompEldSleeper::WBCompEldSleeper()
    : m_IsAwake(false), m_NoiseThreshold(0.0f) {
...
/*virtual*/ void WBCompEldSleeper::InitializeFromDefinition(
  ...
  m_NoiseThreshold =
      ConfigManager::GetInheritedFloat(sNoiseThreshold, 0.0f, sDefinitionName);
}
