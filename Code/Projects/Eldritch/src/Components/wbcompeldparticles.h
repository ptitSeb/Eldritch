...
class WBCompEldParticles : public WBEldritchComponent {
 ...
 private:
  void AddParticleSystem(const SimpleString& DefinitionName,
                         const bool Serialize, const bool Attached,
                         const Vector* const pLocationOverride);
  void AddParticleSystem(const SimpleString& DefinitionName,
                         const bool Serialize, const bool Attached,
                         const Vector& Location, const Angles& Orientation);
