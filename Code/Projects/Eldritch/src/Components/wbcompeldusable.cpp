...
WBCompEldUsable::WBCompEldUsable()
    : m_HoldReleaseMode(false), m_RefireRate(0.0f), m_RefireTime(0.0f) {}

WBCompEldUsable::~WBCompEldUsable() {}

/*virtual*/ void WBCompEldUsable::InitializeFromDefinition(
  ...
  m_RefireRate =
      ConfigManager::GetInheritedFloat(sRefireRate, 0.0f, sDefinitionName);
}
