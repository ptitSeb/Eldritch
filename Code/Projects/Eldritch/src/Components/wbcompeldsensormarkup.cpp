...
WBCompEldSensorMarkup::WBCompEldSensorMarkup() : m_Radius(0.0f) {}

WBCompEldSensorMarkup::~WBCompEldSensorMarkup() {}

/*virtual*/ void WBCompEldSensorMarkup::InitializeFromDefinition(
  ...
  STATICHASH(Markup);
  m_Markup = ConfigManager::GetInheritedHash(sMarkup, HashedString::NullString,
                                             sDefinitionName);
