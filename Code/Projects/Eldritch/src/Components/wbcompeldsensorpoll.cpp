...
/*virtual*/ void WBCompEldSensorPoll::InitializeFromDefinition(
  ...
  m_TickDeltaMin =
      ConfigManager::GetInheritedFloat(sTickDeltaMin, 0.0f, sDefinitionName);

  STATICHASH(TickDeltaMax);
  m_TickDeltaMax =
      ConfigManager::GetInheritedFloat(sTickDeltaMax, 0.0f, sDefinitionName);
}
