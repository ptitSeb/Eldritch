...
WBCompEldPowerTeleport::WBCompEldPowerTeleport() : m_Beacon() {}
...
void WBCompEldPowerTeleport::TryTeleport() const {
  ...
  WBCompEldTransform* const pBeaconTransform =
      pBeacon->GetTransformComponent<WBCompEldTransform>();
  ...
  WBCompEldTransform* const pOwnerTransform =
      pOwner->GetTransformComponent<WBCompEldTransform>();
