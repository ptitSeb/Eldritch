...
WBCompEldMapMarker::WBCompEldMapMarker() : m_MarkAsRoom(false), m_Texture() {}

WBCompEldMapMarker::~WBCompEldMapMarker() {}

/*virtual*/ void WBCompEldMapMarker::InitializeFromDefinition(
  ...
  m_MarkAsRoom =
      ConfigManager::GetInheritedBool(sMarkAsRoom, false, sDefinitionName);
