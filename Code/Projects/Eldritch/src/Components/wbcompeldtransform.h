...
class WBCompEldTransform : public WBEldritchComponent {
 public:
  ...
  void SetRotationalVelocity(const Angles& NewRotationalVelocity) {
    m_RotationalVelocity = NewRotationalVelocity;
  }
  void ApplyRotationalImpulse(const Angles& RotationalImpulse) {
    m_RotationalVelocity += RotationalImpulse;
  }
