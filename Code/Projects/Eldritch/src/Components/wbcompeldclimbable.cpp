...
WBCompEldClimbable::WBCompEldClimbable()
    : m_UseSnapPlane(false), m_SnapPlane() {}

WBCompEldClimbable::~WBCompEldClimbable() {}

/*virtual*/ void WBCompEldClimbable::InitializeFromDefinition(
  ...
  m_UseSnapPlane =
      ConfigManager::GetInheritedBool(sUseSnapPlane, false, sDefinitionName);
}
