...
class WBCompEldCamera : public WBEldritchComponent {
 public:
  ...
  void SetViewAngleOffsetRoll(const float ViewAngleOffsetRoll) {
    m_ViewAngleOffsetRoll = ViewAngleOffsetRoll;
  }
  ...
  void SetLeanPosition(const float LeanPosition) {
    m_LeanPosition = LeanPosition;
  }
