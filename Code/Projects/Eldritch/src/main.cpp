...
#if BUILD_MAC
// TODO: Fix PrintManager to just keep a SimpleString so I don't have to do this
// gross hack.
...
#endif
{
  ...
  CFURLGetFileSystemRepresentation(
      ResourceURL, TRUE, reinterpret_cast<UInt8*>(ResourcePath), PATH_MAX);
...
#if BUILD_DEV
    Allocator::GetDefault().Report(
        FileStream("memory_exit_report.txt", FileStream::EFM_Write));
#endif
