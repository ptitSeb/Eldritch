...
/*virtual*/ void WBPEEldGetItem::InitializeFromDefinition(
  ...
  STATICHASH(SlotPE);
  m_SlotPE = WBParamEvaluatorFactory::Create(
      ConfigManager::GetString(sSlotPE, "", sDefinitionName));
}

/*virtual*/ void WBPEEldGetItem::Evaluate(
