...
/*virtual*/ void WBPEEldGetFaction::InitializeFromDefinition(
...
/*virtual*/ void WBPEEldGetFaction::Evaluate(
  ...
  const SimpleString Faction =
      ReverseHash::ReversedHash(pFaction->GetFaction());
