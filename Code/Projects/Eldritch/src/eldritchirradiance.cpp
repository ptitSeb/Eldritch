...
SVoxelIrradiance::SVoxelIrradiance() : m_Light() {}

SVoxelIrradiance SVoxelIrradiance::operator+(
    const SVoxelIrradiance& Other) const {
...
/*static*/ SVoxelIrradiance SVoxelIrradiance::Lerp(const SVoxelIrradiance& IrrA,
                                                   const SVoxelIrradiance& IrrB,
                                                   const float T) {
