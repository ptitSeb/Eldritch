...
WBActionEldCheckLine::WBActionEldCheckLine()
    : m_LineLength(0.0f), m_CheckTag() {}

WBActionEldCheckLine::~WBActionEldCheckLine() {}

/*virtual*/ void WBActionEldCheckLine::InitializeFromDefinition(
...
// Copied from WBActionEldSpawnEntity::GetSpawnTransform. For reals, unify this
// stuff somewhere.
void WBActionEldCheckLine::GetLineTransform(Vector& OutLocation,
...
/*virtual*/ void WBActionEldCheckLine::Execute() {
  ...
  if (Info.m_HitEntity) {
    ...
    WB_SET_AUTO(OnLineCheck, Entity, Checked,
                static_cast<WBEntity*>(Info.m_HitEntity));
