...
/*virtual*/ void WBActionEldSetPersistentVar::InitializeFromDefinition(
...
/*virtual*/ void WBActionEldSetPersistentVar::Execute() {
  ...
  WB_DISPATCH_EVENT(WBWorld::GetInstance()->GetEventManager(), SetPersistentVar,
                    NULL);
}