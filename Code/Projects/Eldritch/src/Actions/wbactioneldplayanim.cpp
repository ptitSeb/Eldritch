...
WBActionEldPlayAnim::WBActionEldPlayAnim()
    : m_AnimationName(""), m_Loop(false), m_PlayRatePE() {}

WBActionEldPlayAnim::~WBActionEldPlayAnim() {}

/*virtual*/ void WBActionEldPlayAnim::InitializeFromDefinition(
  ...
  SimpleString PlayRateDef =
      ConfigManager::GetString(sPlayRatePE, "", sDefinitionName);
