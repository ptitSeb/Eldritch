...
// Indicates direction of normal that gets lit; *opposite* of the direction
// light is traveling through volume
enum EIrradianceDir {
  IRRDIR_Right,
  IRRDIR_Left,
  IRRDIR_Front,
...
struct SVoxelIrradiance {
  ...
  static SVoxelIrradiance Lerp(const SVoxelIrradiance& IrrA,
                               const SVoxelIrradiance& IrrB, const float T);
};
