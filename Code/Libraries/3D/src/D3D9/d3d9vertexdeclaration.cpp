...
#define CREATESTREAM(NUM, SIG, TYPE, USAGE, INDEX)         \
  ...
  CREATESTREAM(Index, VD_POSITIONS, D3DDECLTYPE_FLOAT3, D3DDECLUSAGE_POSITION,
               0);
  CREATESTREAM(Index, VD_COLORS, D3DDECLTYPE_D3DCOLOR, D3DDECLUSAGE_COLOR, 0);
#if USE_HDR
  CREATESTREAM(Index, VD_FLOATCOLORS, D3DDECLTYPE_FLOAT4, D3DDECLUSAGE_COLOR,
               0);
  CREATESTREAM(Index, VD_BASISCOLORS, D3DDECLTYPE_FLOAT4, D3DDECLUSAGE_COLOR,
               1);
  CREATESTREAM(Index, VD_BASISCOLORS, D3DDECLTYPE_FLOAT4, D3DDECLUSAGE_COLOR,
               2);

  // For SM2 cards, an alternative way to do HDR colors
  CREATESTREAM(Index, VD_FLOATCOLORS_SM2, D3DDECLTYPE_FLOAT4,
               D3DDECLUSAGE_TEXCOORD, 1);
  CREATESTREAM(Index, VD_BASISCOLORS_SM2, D3DDECLTYPE_FLOAT4,
  ...
  CREATESTREAM(Index, VD_BONEINDICES, D3DDECLTYPE_UBYTE4,
               D3DDECLUSAGE_BLENDINDICES, 0);
  CREATESTREAM(Index, VD_BONEWEIGHTS, D3DDECLTYPE_UBYTE4N,
...
void* D3D9VertexDeclaration::GetDeclaration() { return m_VertexDeclaration; }

uint D3D9VertexDeclaration::GetSignature() { return m_VertexSignature; }