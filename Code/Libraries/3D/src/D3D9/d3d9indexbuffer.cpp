...
D3D9IndexBuffer::~D3D9IndexBuffer() { SafeRelease(m_Indices); }
...
void D3D9IndexBuffer::Init(uint NumIndices, index_t* Indices) {
  ...
  if (Indices) {
    void* TempIndices;
    m_D3DDevice->CreateIndexBuffer(sizeof(index_t) * NumIndices,
                                   D3DUSAGE_WRITEONLY, D3DINDEXFORMAT, MEMPOOL,
                                   &m_Indices, NULL);
...
void* D3D9IndexBuffer::GetIndices() { return m_Indices; }

uint D3D9IndexBuffer::GetNumIndices() { return m_NumIndices; }
