...
D3D9VertexBuffer::~D3D9VertexBuffer() { DeviceRelease(); }
...
void D3D9VertexBuffer::RegisterDeviceResetCallback(
...
#define CREATEBUFFER(USE, TYPE)                                               \
  if (InitStruct.USE) {                                                       \
    void* Temp##USE;                                                          \
    m_D3DDevice->CreateVertexBuffer(sizeof(TYPE) * InitStruct.NumVertices,    \
                                    Usage, 0, MemoryPool, &m_##USE, NULL);    \
...
void* D3D9VertexBuffer::GetPositions() { return m_Positions; }

void* D3D9VertexBuffer::GetColors() { return m_Colors; }

#if USE_HDR
void* D3D9VertexBuffer::GetFloatColors1() { return m_FloatColors1; }

void* D3D9VertexBuffer::GetFloatColors2() { return m_FloatColors2; }

void* D3D9VertexBuffer::GetFloatColors3() { return m_FloatColors3; }
#endif

void* D3D9VertexBuffer::GetUVs() { return m_UVs; }

void* D3D9VertexBuffer::GetNormals() { return m_Normals; }

void* D3D9VertexBuffer::GetTangents() { return m_Tangents; }

void* D3D9VertexBuffer::GetBoneIndices() { return m_BoneIndices; }

void* D3D9VertexBuffer::GetBoneWeights() { return m_BoneWeights; }

uint D3D9VertexBuffer::GetNumVertices() { return m_NumVertices; }
...
IDirect3DVertexBuffer9* D3D9VertexBuffer::InternalGetBuffer(
    EVertexElements VertexType) {
  switch (VertexType) {
    case EVE_Positions:
      return m_Positions;
    case EVE_Colors:
