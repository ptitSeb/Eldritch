...
class View {
 public:
  ...
  View(const Vector& Location, const Vector& Direction, float VerticalFOV,
       float AspectRatio, float NearClip, float FarClip);
  View(const Vector& Location, const Angles& Rotation, float VerticalFOV,
       float AspectRatio, float NearClip, float FarClip);

  // Ortho mode constructors
  View(const Vector& Location, const Vector& Direction, const SRect& Bounds,
       float NearClip, float FarClip);
  View(const Vector& Location, const Angles& Rotation, const SRect& Bounds,
       float NearClip, float FarClip);
  ...
  Vector2 ProjectAndClipToScreen(
      const Vector& Location) const;  // Returns X,Y in range [0,1]
