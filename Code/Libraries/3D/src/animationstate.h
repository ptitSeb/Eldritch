...
struct SAnimationListener {
  SAnimationListener()
      : m_NotifyFinishedFunc(NULL), m_NotifyAnimEventFunc(NULL), m_Void(NULL) {}
  ...
  bool operator==(const SAnimationListener& Other) {
    return (m_NotifyFinishedFunc == Other.m_NotifyFinishedFunc &&
...
class AnimationState {
 public:
  ...
  // This function kind of belongs to the Mesh, BoneArray, and AnimationState
  // classes...
 ...
 private:
  ...
  void CallAnimEvent(AnimEvent* const pAnimEvent,
