...
ETextureAddress RenderStates::GetTextureAddress(
    const HashedString& TextureAddress) {
...
ETextureFilter RenderStates::GetTextureFilter(
    const HashedString& TextureFilter) {
