...
#define VD_BASISCOLORS \
  0x0304  // == 0x0004 | 0x0100 | 0x0200	(needs three bits for three
          // streams)
#define VD_FLOATCOLORS_SM2 0x0400
#define VD_BASISCOLORS_SM2 \
  0x1C00  // == 0x0400 | 0x0800 | 0x1000	(needs three bits for three
          // streams)
