...
VertexDeclarationManager::VertexDeclarationManager(IRenderer* pRenderer)
    : m_VertexDeclarations(), m_Renderer(pRenderer) {}

VertexDeclarationManager::~VertexDeclarationManager() {
  FreeVertexDeclarations();
}

IVertexDeclaration* VertexDeclarationManager::GetVertexDeclaration(
    uint VertexSignature) {
  Map<uint, IVertexDeclaration*>::Iterator VDeclIter =
      m_VertexDeclarations.Search(VertexSignature);
  if (VDeclIter.IsNull()) {
