...
RodinBTNodeCastResult::RodinBTNodeCastResult() : m_ValuePE() {}

RodinBTNodeCastResult::~RodinBTNodeCastResult() {}

void RodinBTNodeCastResult::InitializeFromDefinition(
...
/*virtual*/ RodinBTNode::ETickStatus RodinBTNodeCastResult::Tick(
    float DeltaTime) {
