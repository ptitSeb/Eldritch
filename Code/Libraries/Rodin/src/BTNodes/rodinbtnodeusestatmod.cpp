...
RodinBTNodeUseStatMod::RodinBTNodeUseStatMod() : m_StatModEvent() {}

RodinBTNodeUseStatMod::~RodinBTNodeUseStatMod() {}

void RodinBTNodeUseStatMod::InitializeFromDefinition(
  ...
  m_StatModEvent = ConfigManager::GetHash(
      sStatModEvent, HashedString::NullString, sDefinitionName);
}
