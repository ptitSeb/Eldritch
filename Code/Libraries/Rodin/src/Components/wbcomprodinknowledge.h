...
class WBCompRodinKnowledge : public WBComponent {
 public:
  ...
  TKnowledge& UpdateEntity(const WBEntityRef& Entity,
  ...
  // Helper functions
  bool GetLastKnownLocationFor(const WBEntity* const pEntity,
 ...
 private:
  ...
  TKnowledgeMap m_KnowledgeMap;  // Transient; map from entity to
                                 // project-specific knowledge about it
