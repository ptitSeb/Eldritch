...
WBPERodinBlackboardGet::WBPERodinBlackboardGet() : m_BlackboardKey() {}

WBPERodinBlackboardGet::~WBPERodinBlackboardGet() {}

void WBPERodinBlackboardGet::InitializeFromDefinition(
...
void WBPERodinBlackboardGet::Evaluate(
  ...
  WBCompRodinBlackboard* const pBlackboard =
      GET_WBCOMP(Context.m_Entity, RodinBlackboard);
  ASSERT(pBlackboard);

  // Cases not listed here are either unsupported by WBEvents or by
  // WBParamEvaluators.
