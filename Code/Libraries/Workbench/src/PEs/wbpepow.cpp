...
void WBPEPow::Evaluate(
  ...
  ASSERT(ValueA.m_Type == WBParamEvaluator::EPT_Int ||
         ValueA.m_Type == WBParamEvaluator::EPT_Float);
  ASSERT(ValueB.m_Type == WBParamEvaluator::EPT_Int ||
