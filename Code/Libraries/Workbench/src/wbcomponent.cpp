...
/*static*/ void WBComponent::RegisterWBCompFactory(const HashedString& TypeName,
...
// NOTE: This only initializes core Workbench factories. For registering
// extensions in
// external libraries, register other component headers wherever this function
// is called.
...
/*static*/ WBComponent* WBComponent::Create(const HashedString& TypeName,
...
/*virtual*/ void WBComponent::InitializeFromDefinition(
    const SimpleString& DefinitionName) {
...
// As a placeholder for future development, every component at minimum
// serializes a uint.
// This can be used as a version number later. These functions should not be
// called by
...
float WBComponent::GetTime() const { return WBWorld::GetInstance()->GetTime(); }
