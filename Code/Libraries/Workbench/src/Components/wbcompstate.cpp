...
WBCompState::WBCompState() : m_State() {}

WBCompState::~WBCompState() {}

/*virtual*/ void WBCompState::InitializeFromDefinition(
  ...
  m_State = ConfigManager::GetInheritedHash(
      sInitialState, HashedString::NullString, sDefinitionName);
}
