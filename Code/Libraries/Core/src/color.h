...
#define RGB_TO_BGRCOLOR(r, g, b)          \
  ((uint)(B_TO_COLOR(r) | G_TO_COLOR(g) | \
          R_TO_COLOR(b)))  // Hack for reversed byte ordering
#define ARGB_TO_COLOR(a, r, g, b) \
  ((uint)(A_TO_COLOR(a) | R_TO_COLOR(r) | G_TO_COLOR(g) | B_TO_COLOR(b)))
