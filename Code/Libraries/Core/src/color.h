...
#define A_FROM_COLOR( c )	( (unsigned char)( ( ( c ) >> 0 ) &0xff ) )
#define R_TO_COLOR( r )		( (uint)( ( ( r ) & 0xff ) << 8 ) )
#define G_TO_COLOR( g )		( (uint)( ( ( g ) & 0xff ) << 16 ) )
#define B_TO_COLOR( b )		( (uint)( ( ( b ) & 0xff ) << 24 ) )
#define A_TO_COLOR( a )		( (uint)( ( ( a ) & 0xff ) << 0 ) )
#define SET_COLOR_R( c, r )	( ( ( c ) & 0xffff00ff ) | R_TO_COLOR(r) )
#define SET_COLOR_G( c, g )	( ( ( c ) & 0xff00ffff ) | G_TO_COLOR(g) )
#define SET_COLOR_B( c, b )	( ( ( c ) & 0x00ffffff ) | B_TO_COLOR(b) )
#define SET_COLOR_A( c, a )	( ( ( c ) & 0xffffff00 ) | A_TO_COLOR(a) )
#else
