...
void Test::DeleteInstance() { SafeDelete(m_Instance); }

void Test::IncrementTotal() { ++m_TotalTests; }

void Test::IncrementSuccessful() { ++m_SuccessfulTests; }

int Test::GetNumFailed() { return m_TotalTests - m_SuccessfulTests; }
...
void Test::CloseReport() {
  m_Stream->PrintF("\n%d tests, %d succeeded, %d failed.", m_TotalTests,
                   m_SuccessfulTests, m_TotalTests - m_SuccessfulTests);
}