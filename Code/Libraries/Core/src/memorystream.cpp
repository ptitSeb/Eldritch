...
int MemoryStream::GetPos() const { return (int)m_Offset; }
...
int MemoryStream::Size() const { return (int)m_Size; }

const byte* MemoryStream::GetReadPointer() const { return m_Data + m_Offset; }

int MemoryStream::GetRemainingSize() const { return m_Size - m_Offset; }