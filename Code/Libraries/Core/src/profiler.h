...
#define PROFILE_INTERNAL(entry, hash, hook, permanent) \
  static const HashedString hash(entry);               \
  ProfilerHook hook(entry, hash, permanent)
...
#define PROFILE_FUNCTION                                                     \
  PROFILE_INTERNAL(__FUNCSIG__, sFunctionProfilerHash, FunctionProfilerHook, \
                   true)
#define FRAME_PROFILE_FUNCTION                              \
  PROFILE_INTERNAL(__FUNCSIG__, sFunctionFrameProfilerHash, \
                   FunctionFrameProfilerHook, false)
...
#define PROFILE_SCOPE(n) \
  PROFILE_INTERNAL(#n, sScopeProfilerHash, ScopeProfilerHook, true)
#define PROFILE_BEGIN(n) \
  {                      \
  PROFILE_INTERNAL(#n, s##n##ProfilerHash, n##ProfilerHook, true)
#define PROFILE_END }

#define FRAME_PROFILE_SCOPE(n) \
  PROFILE_INTERNAL(#n, sScopeFrameProfilerHash, ScopeFrameProfilerHook, false)
#define FRAME_PROFILE_BEGIN(n) \
  {                            \
  PROFILE_INTERNAL(#n, s##n##FrameProfilerHash, n##FrameProfilerHook, false)
...
class Profiler {
 public:
  ...
  // These are public just for ease and speed (accessing without function
  // overhead), else they'd be private
  Clock* m_Clock;
