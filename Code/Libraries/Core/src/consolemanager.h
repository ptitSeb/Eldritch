...
class ConsoleManager {
 public:
  ...
  void PushCommands(const SimpleString& Commands);  // This can accept command
                                                    // strings (e.g. "world
                                                    // <worldfile>"), not just
                                                    // atomic commands
 ...
 private:
  ...
  void AddCommand(const SimpleString& Command);  // This only accepts unit words
                                                 // as commands; use
                                                 // PushCommands instead
  void ClearBuffer();
  void GetNextHistory();
  void GetPrevHistory();
