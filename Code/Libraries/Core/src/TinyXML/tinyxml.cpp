...
TiXmlNode* TiXmlNode::LinkEndChild(TiXmlNode* node) {
  ...
  assert(node->GetDocument() == nullptr ||
...
float TiXmlElement::GetFloatFromAttribute(const char* Name,
                                          float Default) const {
...
double TiXmlElement::GetDoubleFromAttribute(const char* Name,
...
const char* TiXmlElement::GetStringFromAttribute(const char* Name,
