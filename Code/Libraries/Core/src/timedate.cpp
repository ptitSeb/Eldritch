...
int TimeDate::GetHours24() { return GetLocalTime().tm_hour; }
...
int TimeDate::GetMinutes() { return GetLocalTime().tm_min; }

int TimeDate::GetSeconds() { return GetLocalTime().tm_sec; }

int TimeDate::GetDay() { return GetLocalTime().tm_mday; }

int TimeDate::GetMonth() { return GetLocalTime().tm_mon; }

int TimeDate::GetYear() { return GetLocalTime().tm_year + 1900; }
