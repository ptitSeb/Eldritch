...
int VKKeys[Keyboard::EB_Max] = {
    ...
    'O',          'P',           'Q',         'R',          'S',
    'T',          'U',           'V',         'W',          'X',
    'Y',          'Z',           VK_SPACE,    VK_LSHIFT,    VK_LCONTROL,
    VK_LMENU,     VK_RSHIFT,     VK_RCONTROL, VK_RMENU,     VK_CAPITAL,
    ...
    VK_MULTIPLY,  VK_ADD,        VK_SUBTRACT, VK_DIVIDE,    VK_RETURN,
    VK_INSERT,    VK_HOME,       VK_PRIOR,    VK_DELETE,    VK_END,
    VK_NEXT,      VK_ESCAPE,     '1',         '2',          '3',
    '4',          '5',           '6',         '7',          '8',
    '9',          '0',           VK_BACK,     VK_OEM_MINUS, VK_OEM_PLUS,
    VK_TAB,       VK_F1,         VK_F2,       VK_F3,        VK_F4,
...
SDL_Keycode SDLKeycodes[Keyboard::EB_Max] = {
    SDLK_UNKNOWN,      SDLK_a,         SDLK_b,          SDLK_c,
    SDLK_d,            SDLK_e,         SDLK_f,          SDLK_g,
    SDLK_h,            SDLK_i,         SDLK_j,          SDLK_k,
    SDLK_l,            SDLK_m,         SDLK_n,          SDLK_o,
    SDLK_p,            SDLK_q,         SDLK_r,          SDLK_s,
    SDLK_t,            SDLK_u,         SDLK_v,          SDLK_w,
    SDLK_x,            SDLK_y,         SDLK_z,          SDLK_SPACE,
    SDLK_LSHIFT,       SDLK_LCTRL,     SDLK_LALT,       SDLK_RSHIFT,
    SDLK_RCTRL,        SDLK_RALT,      SDLK_CAPSLOCK,   SDLK_COMMA,
    SDLK_PERIOD,
    SDLK_SLASH,         // /?
    SDLK_SEMICOLON,     // ;:
    SDLK_QUOTE,         // '"
    ...
    SDLK_KP_8,         SDLK_KP_9,      SDLK_KP_DECIMAL, SDLK_KP_MULTIPLY,
    SDLK_KP_PLUS,      SDLK_KP_MINUS,  SDLK_KP_DIVIDE,  SDLK_RETURN,
    SDLK_INSERT,       SDLK_HOME,      SDLK_PAGEUP,     SDLK_DELETE,
    SDLK_END,          SDLK_PAGEDOWN,  SDLK_ESCAPE,     SDLK_1,
    SDLK_2,            SDLK_3,         SDLK_4,          SDLK_5,
    SDLK_6,            SDLK_7,         SDLK_8,          SDLK_9,
    SDLK_0,            SDLK_BACKSPACE, SDLK_MINUS,      SDLK_PLUS,
    SDLK_TAB,          SDLK_F1,        SDLK_F2,         SDLK_F3,
    SDLK_F4,           SDLK_F5,        SDLK_F6,         SDLK_F7,
    SDLK_F8,           SDLK_F9,        SDLK_F10,        SDLK_F11,
    SDLK_F12,

    SDLK_UNKNOWN,  // SDL actually uses the mouse for mouse input. What a novel
                   // concept.
    SDLK_UNKNOWN,      SDLK_UNKNOWN,
};
#endif  // BUILD_SDL

Keyboard::Keyboard() : m_CurrentState(), m_LastState() {
