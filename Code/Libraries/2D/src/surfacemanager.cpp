...
SurfaceManager::SurfaceManager() : m_Surfaces() {}
...
void SurfaceManager::DeleteInstance() { SafeDelete(m_Instance); }

Surface* SurfaceManager::GetSurface(const char* Filename,
                                    Surface::ESurfaceFileType FileType) {
