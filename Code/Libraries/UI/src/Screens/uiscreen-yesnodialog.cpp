...
void UIScreenYesNoDialog::SetParameters(
    ...
    const SimpleString& YesNoDynamicString, const HashedString& YesEvent,
    const HashedString& NoEvent, const SimpleString& YesCommand,
    const SimpleString& NoCommand, const SUICallback& YesCallback,
    const SUICallback& NoCallback, const Array<WBAction*>* const pYesActions,
  ...
  pDialog->m_DynamicString =
      ConfigManager::GetLocalizedString(YesNoDynamicString, "");
