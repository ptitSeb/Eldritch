...
UIScreenOKDialog::UIScreenOKDialog() { InitializeFromDefinition("OKDialog"); }

UIScreenOKDialog::~UIScreenOKDialog() {}

void UIScreenOKDialog::SetParameters(bool PauseGame,
  ...
  pDialog->m_DynamicString =
      ConfigManager::GetLocalizedString(OKDynamicString, "");
