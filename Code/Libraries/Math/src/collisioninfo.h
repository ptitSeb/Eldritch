...
class CollisionInfo {
 public:
  ...
  bool m_CollideNonBlockingEntities;  // Used for ray/segment traces against
                                      // usable but non-blockable entities
  ...
  void* m_TargetEntity;  // If non-null, this is the only entity which will be
                         // traced against
  ...
  void* m_HitEntity;
  Mesh* m_HitMesh;
  HashedString m_HitName;  // Description of the hit region. Real strings are
