...
class Ellipsoid {
 public:
  ...
  bool SweepAgainst(const Ellipsoid& e, const Vector& v,
                    CollisionInfo* const pInfo) const;
  bool SweepAgainst(const AABB& a, const Vector& v) const;
  bool SweepAgainst(const CollisionTriangle& t, const Vector& v,
                    const AABB& SweepAABB, CollisionInfo* const pInfo) const;
  bool SweepAgainst(const CollisionMesh& m, const Vector& v,
                    const AABB& SweepAABB, CollisionInfo* const pInfo) const;
